...
const HeroBanner = () => {
  return (
    <div className="relative flex flex-col-reverse px-4 py-16 mx-auto lg:block lg:flex-col lg:py-32 xl:py-48 md:px-8 sm:max-w-xl md:max-w-full border-b-2">
      ...
      <div className="mb-16 lg:pr-5 lg:max-w-lg lg:mb-0">
        ...
        <form>
          ...
          <div className="flex items-center mt-4">
            ...
            <Link href="/contact">
                <p className='inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-600 hover:bg-blue-700 focus:shadow-outline focus:outline-none'>
                Get in Touch
                </p>
            </Link>
            <a
