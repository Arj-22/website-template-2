...
const NavBarThree = () => {
    ...
    const handleNavBar = () =>{
        window.scrollY > 10 ? setShadow(" shadow-2xl") : setShadow("") 
    }
...
<nav className={"bg-white dark:bg-gray-900 w-full z-20 top-0 left-0  border-gray-200 dark:border-gray-600 fixed" + shadow}>
